...
<form action="{{route('books.index')}}" method="GET" class="mb-4 flex ml-4 items-center space-x-2">
    <input type="text" name="title" placeholder="Search book by title" value="{{request('title')}}"
        class="input h-10" />
